                ...
                <table class="table table-striped jambo_table bulk_action " cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 30%;">{{$post->postName}}</td>
                            <td style="width: 8%;">{{$post->subName}}</td>
                            <td style="width: 10%;"><button class="btn btn-primary">{{$post->status}}</button></td>
                            <td style="width: 8%; text-align:center">{{$post->viewed}}</td>
